...
IPVPS=$(curl -sS https://raw.githubusercontent.com/diah082/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Pasang
else
...
function key2(){
    ...
    if [[ $key == "1" ]]; then
        ...
        cd
        git clone https://github.com/diah082/izin >/dev/null 2>&1
		cd izin
...
TIMES="10"
CHATID="6665982160"
KEY="6957568625:AAFg73_UjmNn7Au003FT9WjKzIQ2r3Gd7io"
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/diah082/izin/main/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
